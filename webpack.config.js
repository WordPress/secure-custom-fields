...
const commonConfig = {
	entry: {
		...
		'js/acf-command-palette-core': './assets/src/js/acf-command-palette-core.js',
		'js/acf-command-palette-post-types': './assets/src/js/acf-command-palette-post-types.js',
