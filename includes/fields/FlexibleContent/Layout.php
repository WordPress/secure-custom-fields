...
/**
 * Layout class for handling individual Flexible Content layouts.
 *
 * This class handles rendering and management of individual layouts within a Flexible Content field.
 * It provides methods for constructing, rendering, and manipulating layouts.
 *
 * @since ACF 6.5
 */
class Layout {
	...
	private function action_buttons() {
		...
		<div class="acf-fc-layout-actions-wrap">
			<div class="acf-fc-layout-handle" title="<?php esc_attr_e( 'Drag to reorder', 'secure-custom-fields' ); ?>" data-name="collapse-layout">
			...
			<div class="acf-fc-layout-controls">
				...
				<div class="acf-layout-collapse">
					<a class="acf-icon -collapse -clear" href="#" data-name="collapse-layout" aria-label="<?php esc_attr_e( 'Toggle layout', 'secure-custom-fields' ); ?>"></a>
				</div>
			</div>
		</div>
		<?php
